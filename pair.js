            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'JTECH-WABOT ~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of JTECH-WABOT.
2️⃣ Stay updated with our latest releases and support.
3️⃣ Enjoy seamless WhatsApp automation! 🤖  

🔗 *Join Our WHATSAPP Channel:* 👉 [Click Here to Join] https://whatsapp.com/channel/0029Vb6FovDKwqSJgSOcUS43

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [JTECH-WABOT GitHub Repo](https://github.com/Kingjosh9y/)  

🚀 _Thanks for choosing JTECH-WABOT — Let the automation begin!_ ✨`;
