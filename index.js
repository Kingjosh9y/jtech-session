...
const ownerNumber = ['27721358592']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.replace("JTECH-WABOT~", '');
...
console.log("CONNECTING JTECH-WABOT 🧬...");
...
console.log('JTECH-WABOT CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ JTECH-WABOT ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ JTECH ✅*

> *❁ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ ғᴏʀ quoted msgs

https://whatsapp.com/channel/0029Vb6FovDKwqSJgSOcUS43
...
if(senderNumber.includes("27721358592")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("27721358592")){
...
app.get("/", (req, res) => {
res.send("HEY, JTECH-WABOT STARTED ✅");
});
